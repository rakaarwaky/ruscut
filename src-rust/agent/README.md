...
In the Agentic Engineering System (AES) design pattern, the Agent layer acts as the system's "brain" and "Composition Root." It is situated at Level 5, bridging high-level UI/CLI surfaces (Level 6) with core Capabilities (Level 3) and Infrastructure adapters (Level 4).
